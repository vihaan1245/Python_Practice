...
sampleData = {
    ...
    "item_2": {
        ...
        "extras": {
            ...
            "warranty": {"years": 1, "type": "vendor"}
        }
    },
    "item_3": {
        "name": "Product 3",
        "price": 15.0,
        "tags": ["garden", "outdoor", "tool"],
        "availability": {
            "store": "Store A",
            "online": True
        },
        ...
        "extras": {
            "accessories": ["cover", "sprinkler"],
            "warranty": {"years": 3, "type": "manufacturer"}
        }
    },
    "item_4": {
        "name": "Product 4",
        "price": 49.99,
        "tags": ["apparel", "fashion", "sale"],
        "availability": {
            "store": "Store C",
            "online": True
        },
    ...
    "item_5": {
        ...
        "extras": {
            "energy_rating": "A++",
            "warranty": {"years": 5, "type": "manufacturer"}
        }
    },
    "item_6": {
        "name": "Product 100",
        ...
        "extras": {
            "colors": ["yellow", "blue"],
            "sizes": ["S", "M", "L"],
            "warranty": {"years": 2, "type": "vendor"}
        }
    }
}

def walk_through(d,indent=0):
    if isinstance(d, dict):
        for k,v in d.items():
            print(" "*indent , k)
            walk_through(v,indent+4)

    elif isinstance(d,list):
        for index,item in enumerate(d):
            walk_through(item,indent)
